...
function PrivacyPolicy() {
  return (
    <>
      <SectionTitle content="Политика приватности" />
      <div>
        ...
        безопасности персональных данных, предпринимаемые Неретин Иван Иванович
        ...
        https://iineretin.ru. 2. Основные понятия, используемые в Политике 2.1.
        ...
        https://iineretin.ru. 2.4. Информационная система персональных данных —
        ...
        определяемому Пользователю веб-сайта https://iineretin.ru. 2.9.
        ...
        https://iineretin.ru. 2.11. Предоставление персональных данных —
        ...
        электронных писем Персональные данные электронный адрес номера телефонов
        имя Правовые основания уставные (учредительные) документы Оператора Виды
        обработки персональных данных Сбор, запись, систематизация, накопление,
        ...
        действующего законодательства в области защиты персональных данных. 8.1.
        ...
        неуполномоченных лиц. 8.2. Персональные данные Пользователя никогда, ни
        ...
        электронной почты Оператора ivanhotepp@gmail.com с пометкой
        ...
        Оператора ivanhotepp@gmail.com с пометкой «Отзыв согласия на обработку
        ...
        персональных данных. 9. Перечень действий, производимых Оператором с
        полученными персональными данными 9.1. Оператор осуществляет сбор,
        ...
        сетям или без таковой. 10. Трансграничная передача персональных данных
        ...
        сведения. 11. Конфиденциальность персональных данных Оператор и иные
        ...
        законом. 12. Заключительные положения 12.1. Пользователь может получить
        ...
        ivanhotepp@gmail.com. 12.2. В данном документе будут отражены любые
